...
update_pkg "py3-attrs" "Python Classes" "false" "$COMMUNITY_PKG_URL" "(\d+\.)+\d+-r\d+"
...
update_pkg "py3-openssl" "Python OpenSSL" "false" "$COMMUNITY_PKG_URL" "(\d+\.)+\d+-r\d+"
update_pkg "py3-service_identity" "Python Service-Identity" "false" "$COMMUNITY_PKG_URL" "(\d+\.)+\d+-r\d+"
